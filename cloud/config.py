...
BASE_DIR = Path(__file__).parent        # ex6/cloud/
ROOT_DIR = BASE_DIR.parent              # ex6/

SECRET_KEY = os.environ.get('CLOUD_SECRET_KEY', 'cloud-secret-key-lab7')
DATABASE = str(ROOT_DIR / 'cloud.db')
UPLOAD_FOLDER = str(ROOT_DIR / 'cloud_storage')
...
AUDIT_LOG = str(ROOT_DIR / 'cloud_audit.log')
